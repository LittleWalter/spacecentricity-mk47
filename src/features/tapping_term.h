...
#define BASE_RIGHT_THUMB_TAP_TERM_REDUCE 25 // ms to make right thumb feel more responsive
#define MOD_OR_LAYER_REDUCE              30 // ms to make top-row mods and home-row layers feel more responsive
