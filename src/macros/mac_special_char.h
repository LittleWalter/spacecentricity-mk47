...
typedef enum {
    ...
    CHAR_ARROW_UP,
    CHAR_ARROW_DOWN,
    CHAR_DOUBLE_ARROW_LEFT,
    CHAR_DOUBLE_ARROW_RIGHT,
    CHAR_DOUBLE_ARROW_UP,
    CHAR_DOUBLE_ARROW_DOWN,
    // Legal/Typography
    CHAR_COPYRIGHT,          // Copyright (©)
    CHAR_REGISTERED,         // Registered (®)
    CHAR_TRADEMARK,          // Trademark (™)
    CHAR_SECTION,            // Section (§)
    CHAR_PARAGRAPH,          // Paragraph (¶)
    // Whitespace/Control Symbols
    CHAR_OPEN_BOX,           // Space (␣)
    CHAR_CARRIAGE_RETURN,    // Return (⏎)
    CHAR_ENTER,              // Enter (↵)
    CHAR_TAB,                // Tab (⇥)
    CHAR_TAB_REVERSE,        // Enter (⇤)
