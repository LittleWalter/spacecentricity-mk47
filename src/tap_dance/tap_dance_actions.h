...
// Constructs the full name of a tap-dance state given a prefix
#define TAP_DANCE(name) (name##_tap_dance)

// Declares a tap-dance state struct
#define TD_DEF(name) \
    static td_tap_t TAP_DANCE(name) = { .is_press_action = true, .state = TD_NONE }

// Gets the tap dance .state field
#define TD_STATE(name) (TAP_DANCE(name).state)

// Set .state field from cur_dance()
#define TD_STATE_SET(name) TD_STATE(name) = cur_dance(state)

// Resets .state field to TD_NONE
#define TD_RESET(name) TD_STATE(name) = TD_NONE
...
enum {                 // │  Tap   │ 2xTap  │Tap+Hold│  Hold  │ Notes
    ...
    TD_RBRC,           // │   ]    │   )    │   }    │   >    │ Triple tap: ≥
                       // │        │        │        │        │
    TD_0,              // │   0    │        │SAVEFAV0│LEADER 0│
    TD_1,              // │   1    │        │SAVEFAV1│LEADER 1│
    TD_2,              // │   2    │        │SAVEFAV2│LEADER 2│
    TD_3,              // │   3    │        │SAVEFAV3│LEADER 3│
    TD_4,              // │   4    │        │SAVEFAV4│LEADER 4│
    TD_5,              // │   5    │        │SAVEFAV5│LEADER 5│
    TD_6,              // │   6    │        │SAVEFAV6│LEADER 6│
    TD_7,              // │   7    │        │SAVEFAV7│LEADER 7│
    TD_8,              // │   8    │        │SAVEFAV8│LEADER 8│
    TD_9,              // │   9    │        │SAVEFAV9│LEADER 9│
                       // │        │        │        │        │
