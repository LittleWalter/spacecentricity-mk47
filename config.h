// Version tracking for this QMK firmware
#define SPACECENTRICITY_VERSION_MAJOR 0
#define SPACECENTRICITY_VERSION_MINOR 1
#define SPACECENTRICITY_VERSION_PATCH 0
